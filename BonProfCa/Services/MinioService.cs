...
public class MinioService
{
    ...
    public MinioService()
    {
        string endpoint = EnvironmentVariables.MINIO_ENDPOINT;
        string accessKey = EnvironmentVariables.MINIO_ACCESSKEY;
        string secretKey = EnvironmentVariables.MINIO_SECRETKEY;
